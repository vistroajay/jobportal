...
<div id="registrationpage" class="modal fade" role="dialog">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-primary">Mission and values</h1>
          <hr>
          <div class="col-md-2 text-center">
            <img src="images/logo.jpg" class="img-responsive img-thumbnail">
          </div>
          <div class="col-md-10">
            <div>VISTRO INFO SOLUTIONS PVT LTD #L-4, 3rd Floor,Sector 12,Jeevanbheemanagar,
              landmark: Opp: NAL Quaters, Kodihalli, Bengaluru-560075, +91-9916171297
              info@vistroinfo.com VISTRO INFO SOLUTIONS PVT LTD #L-4, 3rd Floor,Sector
              12,Jeevanbheemanagar, landmark: Opp: NAL Quaters, Kodihalli, Bengaluru-560075,
              +91-9916171297 info@vistroinfo.com VISTRO INFO SOLUTIONS PVT LTD #L-4,
              3rd Floor,Sector 12,Jeevanbheemanagar, landmark: Opp: NAL Quaters, Kodihalli,
              Bengaluru-560075, +91-9916171297 info@vistroinfo.com</div>
          </div>
        </div>
        <div class="col-md-12">
          <h1 class="text-primary">Why VistroJobs?</h1>
          <hr>
          <div class="col-md-2 text-center">
            <img src="images/logo.jpg" class="img-responsive img-thumbnail">
          </div>
        ...
        <div class="col-md-12">
          <h1 class="text-primary">Management Team</h1>
          <hr>
            <div class="section">
                <div class="container">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <img src="images\person.jpg" class="center-block img-circle img-responsive">
        ...
        <div class="col-md-12">
          <h1 class="text-primary">Offices Address</h1>
          <hr>
          <div class="col-md-2 text-center">
            <img src="images/logo.jpg" class="img-responsive img-thumbnail">
          </div>
          <div class="col-md-10">
            <div>VISTRO INFO SOLUTIONS PVT LTD
              <br>#L-4, 3rd Floor,Sector 12,Jeevanbheemanagar,
              <br>landmark: Opp: NAL Quaters, Kodihalli, Bengaluru-560075,
              <br>+91-9916171297 info@vistroinfo.com</div>
          </div>
        </div>
          <br>
      </div>
