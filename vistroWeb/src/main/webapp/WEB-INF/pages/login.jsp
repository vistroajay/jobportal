				...
				<div class="row">
					<div class="col-md-4"><!-- logo -->
						<a href="index.html" title="Job Board" rel="home">
							<img class="logosize" src="resources/images/logo.jpg" alt="job board" />
						</a>
					</div><!-- logo -->
				...
				<div class="row">
					<div class="col-md-5">
						<div class="form-singin-container">
							<form name="form" id="form" class="form-horizontal" method="POST" action="${pageContext.request.contextPath}/login/signin">
								<div class="form-group">
									<input type="email" id="EmailID" name="EmailID" class="form-control input-form" placeholder="Email">
