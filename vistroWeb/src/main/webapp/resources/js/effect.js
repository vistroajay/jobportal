...
function addeducationbutton() {
        ...
        $("#myform2").append("<div class=\"form-group\"><div class=\"col-sm-2 col-xs-10 col-md-12 col-lg-2\"><label class=\"control-label\" id=\"duration\">Duration</label></div><div class=\"col-sm-1 col-xs-4 col-md-12 col-lg-10\"><div class=\"form-row\"><div class=\"col-lg-5\">From: <input type=\"text\" id=\"experiencefrom\"> </div> <div class=\"col-lg-5\">To: <input type=\"text\" id=\"experienceto\"> </div> <div class=\"col-lg-4\"></div> </div> </div> </div>" +
        ...
        $("#myform3").append("<div class=\"form-group\"><div class=\"col-sm-2 col-xs-12 col-md-2 col-lg-2\"><label for=\"certification\" class=\"control-label\">Certification</label></div><div class=\"col-sm-9 col-xs-12 col-md-9 col-lg-9\"> <input type=\"text\" class=\"form-control form-dark\" id=\"certification\" placeholder=\"Certification\" class=\"form-control\" id=\"certification disabledinput\" type=\"text\"></div><div id=\"certification-message\" class=\"error-message\"></div></div>" +
            "<div class=\"form-group\"><div class=\"col-sm-2 col-xs-10 col-md-12 col-lg-2\"><label class=\"control-label\" id=\"duration1\">Duration</label></div><div class=\"col-sm-1 col-xs-4 col-md-12 col-lg-10\"> <div class=\"form-row\"><div class=\"col-lg-5\">From: <input type=\"text\" id=\"certificationfrom\"></div><div class=\"col-lg-5\">To: <input type=\"text\" id=\"certificationto\"></div><div class=\"col-lg-4\"></div></div></div></div>")
